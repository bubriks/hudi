...
public class IndexRecordId implements Serializable {
  ...
  @Column(name = "record_key", columnDefinition = "VARBINARY(255)", nullable = false)
  private byte[] key;

  @Column(name = "commit_ts", nullable = false)
  ...
  public String getCommitTimeString() {
    return HoodieActiveTimeline.formatDate(commitTimestamp);
  }
  ...
  public void setCommitTime(String commitTimestamp) throws ParseException {
    this.commitTimestamp = HoodieActiveTimeline.parseDateFromInstantTime(commitTimestamp);
  }
}